...
class Message_model extends CI_Model{
    public function get_all(){
        $sql = "select t_user.portrait,t_user.username,t_message.content,t_message.message_id,t_message.addtime from t_message,t_user where t_message.sender = t_user.user_id";
    ...
    public function get_by_page($limit=7,$offset=0){
        $this->db->select('t_user.portrait,t_user.username,t_message.content,t_message.message_id,t_message.addtime');
        $this->db->from('t_message');
