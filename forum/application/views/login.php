...
<div id="login_frame">  
    ...
    <form method="post" action="welcome/do_login">  
  
        <p><label class="label_input">电话号</label><input type="number" placeholder="请输入电话号登陆" name="name" id="username" class="text_field"/></p>  
