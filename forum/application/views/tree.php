...
} ?>><button class="btn btn-primary">添加树洞</button></a></h4>
	<div class="container">
		...
		<div class="modal-dialog ">
			<div class="modal-content">
				<div class="modal-header">
			        ...
			        <h4 class="modal-title" id="myModalLabel">新增树洞</h4>
			    </div>
				<div class="modal-body">
				<form action="welcome/add_tree"  method="post" enctype="multipart/form-data">
